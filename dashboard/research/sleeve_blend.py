...
def _sleeve_trades(ticker: str) -> list[dict]:
    ...
    20dMA*0.975, RSI14<35, ADX14>25 -> long; exit at first of 5MA-touch / +3% TP / -5% SL /
    ...
    SAME DAY, separately: ADX threshold raised 20->25 (vix_drop_stress_test.py's sweep found
    a better risk-adjusted tradeoff, user-approved)."""
    ...
    ent = (sv < m20v * 0.975) & (r14v < 35) & (adxv > 25)
