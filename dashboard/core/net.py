...
# Put the repo-root quant/ dir on the path so we can reuse analyst/, data.py, etc.
# net.py lives at dashboard/core/net.py -> parents[2] is the repo root.
_QUANT_DIR = str(pathlib.Path(__file__).resolve().parents[2])
